...
var stage = 0;
var time = 0;
var latency = .1; // seconds of audio delay, varies with computer, should set to .1 when submitting final work
...
function endGame(message) {
	...
	if (won) {
		...
		$("#speed").show();
		//sleep(100); // causes an error but it prevents the txt from being changed again so it's fine
	} else {
		audio.pause();
